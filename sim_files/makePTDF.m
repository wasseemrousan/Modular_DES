...
idx_dTheta_nan = find(isnan(dTheta));
dTheta(idx_dTheta_nan) = 0;

idx_dTheta_inf =  find(isinf(dTheta));
dTheta(idx_dTheta_inf) = 1;

% idx_zero = find (~dTheta);
% dTheta(idx_zero) = 0.00001;
