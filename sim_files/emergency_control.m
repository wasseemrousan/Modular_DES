...
switch opt.optimizer
    ...
    case 'linprog'
        ...
        options.Preprocess = 'none'; % Wasseem 2021 11/29 changed due to errors in run 

        [x_star,fval,exitflag,output] = linprog(cost,A_ineq,b_ineq,A_pf,b_pf,x_min,x_max,options);
